...
/* ──────────────────────────────────────────────
   ...
   국제 배송비를 모르는 사용자가 무게·치수로 대표 요율 추정치를 받아
   입력란에 채울 수 있게 한다. 요율은 data/shipping.js — 업체별로 다르다는
   전제라 '추정치' 표기와 검증일을 함께 보여준다.
...
export default function ShipEstimateField({ countryId, onApply }) {
  ...
  // 적용된 '금액'을 기억한다 — 무게·출발국이 바뀌어 추정치가 달라지면 표시가 저절로 풀린다
