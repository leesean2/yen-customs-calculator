 ...
 * - symbol:       금액 표기(money 포매터)에 쓰는 통화 기호. 숫자 묶음은 통화와 무관하게
 *                 항상 한국식 콤마 — 독일식 "1.234" 등은 한국 사용자가 소수점으로 오독한다.
...
export const ORIGIN_COUNTRIES = [
  { id: "JP", label: "일본", short: "일본", flag: "🇯🇵", currency: "JPY", symbol: "¥", deMinimisUsd: 150, rateUnit: 100, rateUnitLabel: "엔" },
  { id: "US", label: "미국", short: "미국", flag: "🇺🇸", currency: "USD", symbol: "$", deMinimisUsd: 200, rateUnit: 1, rateUnitLabel: "달러" },
  { id: "EU", label: "유럽(유로존)", short: "유럽", flag: "🇪🇺", currency: "EUR", symbol: "€", deMinimisUsd: 150, rateUnit: 1, rateUnitLabel: "유로" },
  { id: "CN", label: "중국", short: "중국", flag: "🇨🇳", currency: "CNY", symbol: "元", deMinimisUsd: 150, rateUnit: 1, rateUnitLabel: "위안" },
];
